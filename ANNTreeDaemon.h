...
class ANNTreeDaemonIf {
 public:
  ...
  virtual void knnSearch(std::vector<Neighbor> & _return, const std::string& feature, const int32_t k) = 0;
  virtual void addFeature(const int64_t id, const std::string& feature) = 0;
  virtual void build() = 0;
  virtual void slaveIndex() = 0;
  virtual void slaveInit() = 0;
  virtual void slaveSave() = 0;
  virtual void slaveAddFeature(const int64_t id, const std::string& feature) = 0;
  virtual void slaveKnnSearch(std::vector<Neighbor> & _return, const std::string& feature, const int32_t k) = 0;
  virtual void similarSearch(std::vector<Neighbor> & _return, const int64_t id, const int32_t k, const std::string& type) = 0;
};
...
class ANNTreeDaemonNull : virtual public ANNTreeDaemonIf {
 public:
  ...
  void knnSearch(std::vector<Neighbor> & /* _return */, const std::string& /* feature */, const int32_t /* k */) {
    return;
  }
  ...
  void slaveKnnSearch(std::vector<Neighbor> & /* _return */, const std::string& /* feature */, const int32_t /* k */) {
    return;
  }
  void similarSearch(std::vector<Neighbor> & /* _return */, const int64_t /* id */, const int32_t /* k */, const std::string& /* type */) {
    return;
  }
};

typedef struct _ANNTreeDaemon_knnSearch_args__isset {
  _ANNTreeDaemon_knnSearch_args__isset() : feature(false), k(false) {}
  bool feature;
  bool k;
...
class ANNTreeDaemon_knnSearch_args {
 public:
  ...
  ANNTreeDaemon_knnSearch_args() : feature(""), k(0) {
  }
...
typedef struct _ANNTreeDaemon_addFeature_args__isset {
  _ANNTreeDaemon_addFeature_args__isset() : id(false), feature(false) {}
  bool id;
  bool feature;
...
class ANNTreeDaemon_addFeature_args {
 public:
  ...
  ANNTreeDaemon_addFeature_args() : id(0), feature("") {
  }
...
class ANNTreeDaemon_build_args {
 public:

  ANNTreeDaemon_build_args() {
  }

  virtual ~ANNTreeDaemon_build_args() throw() {}


  bool operator == (const ANNTreeDaemon_build_args & /* rhs */) const
  {
    return true;
  }
  bool operator != (const ANNTreeDaemon_build_args &rhs) const {
  ...
  bool operator < (const ANNTreeDaemon_build_args & ) const;
...
class ANNTreeDaemon_build_pargs {
 public:


  virtual ~ANNTreeDaemon_build_pargs() throw() {}
...
class ANNTreeDaemon_build_result {
 public:

  ANNTreeDaemon_build_result() {
  }

  virtual ~ANNTreeDaemon_build_result() throw() {}


  bool operator == (const ANNTreeDaemon_build_result & /* rhs */) const
  {
    return true;
  }
  bool operator != (const ANNTreeDaemon_build_result &rhs) const {
  ...
  bool operator < (const ANNTreeDaemon_build_result & ) const;
...
class ANNTreeDaemon_build_presult {
 public:


  virtual ~ANNTreeDaemon_build_presult() throw() {}
...
typedef struct _ANNTreeDaemon_slaveAddFeature_args__isset {
  _ANNTreeDaemon_slaveAddFeature_args__isset() : id(false), feature(false) {}
  bool id;
  bool feature;
...
class ANNTreeDaemon_slaveAddFeature_args {
 public:
  ...
  ANNTreeDaemon_slaveAddFeature_args() : id(0), feature("") {
  }
...
typedef struct _ANNTreeDaemon_slaveKnnSearch_args__isset {
  _ANNTreeDaemon_slaveKnnSearch_args__isset() : feature(false), k(false) {}
  bool feature;
  bool k;
...
class ANNTreeDaemon_slaveKnnSearch_args {
 public:
  ...
  ANNTreeDaemon_slaveKnnSearch_args() : feature(""), k(0) {
  }
...
typedef struct _ANNTreeDaemon_similarSearch_args__isset {
  _ANNTreeDaemon_similarSearch_args__isset() : id(false), k(false), type(false) {}
  bool id;
  bool k;
  bool type;
...
class ANNTreeDaemon_similarSearch_args {
 public:
  ...
  ANNTreeDaemon_similarSearch_args() : id(0), k(0), type("") {
  }
...
class ANNTreeDaemonClient : virtual public ANNTreeDaemonIf {
 public:
  ...
  void knnSearch(std::vector<Neighbor> & _return, const std::string& feature, const int32_t k);
  void send_knnSearch(const std::string& feature, const int32_t k);
  void recv_knnSearch(std::vector<Neighbor> & _return);
  void addFeature(const int64_t id, const std::string& feature);
  void send_addFeature(const int64_t id, const std::string& feature);
  void recv_addFeature();
  void build();
  void send_build();
  void recv_build();
  void slaveIndex();
  void send_slaveIndex();
  ...
  void recv_slaveSave();
  void slaveAddFeature(const int64_t id, const std::string& feature);
  void send_slaveAddFeature(const int64_t id, const std::string& feature);
  void recv_slaveAddFeature();
  void slaveKnnSearch(std::vector<Neighbor> & _return, const std::string& feature, const int32_t k);
  void send_slaveKnnSearch(const std::string& feature, const int32_t k);
  void recv_slaveKnnSearch(std::vector<Neighbor> & _return);
  void similarSearch(std::vector<Neighbor> & _return, const int64_t id, const int32_t k, const std::string& type);
  void send_similarSearch(const int64_t id, const int32_t k, const std::string& type);
...
class ANNTreeDaemonProcessor : public ::apache::thrift::TProcessor {
 ...
 private:
  ...
  void process_build(int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot, void* callContext);
 ...
 public:
  ANNTreeDaemonProcessor(boost::shared_ptr<ANNTreeDaemonIf> iface) :
    ...
    processMap_["build"] = &ANNTreeDaemonProcessor::process_build;
 ...
 public:
  void knnSearch(std::vector<Neighbor> & _return, const std::string& feature, const int32_t k) {
    ...
    for (size_t i = 0; i < sz; ++i) {
      if (i == sz - 1) {
        ifaces_[i]->knnSearch(_return, feature, k);
        return;
      } else {
        ifaces_[i]->knnSearch(_return, feature, k);
      }
  ...
  void addFeature(const int64_t id, const std::string& feature) {
    size_t sz = ifaces_.size();
    for (size_t i = 0; i < sz; ++i) {
      ifaces_[i]->addFeature(id, feature);
    }
  }
  ...
  void slaveAddFeature(const int64_t id, const std::string& feature) {
    size_t sz = ifaces_.size();
    for (size_t i = 0; i < sz; ++i) {
      ifaces_[i]->slaveAddFeature(id, feature);
    }
  }
  ...
  void slaveKnnSearch(std::vector<Neighbor> & _return, const std::string& feature, const int32_t k) {
    ...
    for (size_t i = 0; i < sz; ++i) {
      if (i == sz - 1) {
        ifaces_[i]->slaveKnnSearch(_return, feature, k);
        return;
      } else {
        ifaces_[i]->slaveKnnSearch(_return, feature, k);
      }
  ...
  void similarSearch(std::vector<Neighbor> & _return, const int64_t id, const int32_t k, const std::string& type) {
    ...
    for (size_t i = 0; i < sz; ++i) {
      if (i == sz - 1) {
        ifaces_[i]->similarSearch(_return, id, k, type);
        return;
      } else {
        ifaces_[i]->similarSearch(_return, id, k, type);
      }
